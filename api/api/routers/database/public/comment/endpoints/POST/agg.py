...
from ...database import CommentAsyncDAO, CommentFilter, AggRow, AggRequest
...
async def comment_aggregate(
    ...
    with username_context(token.preferred_username):
        result = await CommentAsyncDAO.agg(
